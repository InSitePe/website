        ...
        <div class="menu-space">
            <div class="content">
                ...
                <div class="side-user">
                    ...
                    <div class="info">
                        <p><strong><?= ucwords($data['nombre_user'] . ' ' . $data['apellido_padre_user'] . ' ' . $data['apellido_madre_user']); ?></strong></p>

                    </div>
                </div>
                <ul id="actionsUser" class="cl-vnavigation">
...
<script src="<?= Yii::app()->theme->baseUrl; ?>/bin/js/aulaapp/slider-user.js"></script>
<script>
